...
const tld = '.angel';
const CONTRACT_ADDRESS = '0xD9A65e0940cDb96E21C072a4A08c05bBe43C0Cfd';
    ...
    try {
      ...
      if (ethereum) {
        ...
        // Wait for the transaction to be mined
          ...
          alert(`Congratulations! You have minted ${domain}.${tld} with SuperPower: ${record} ` );
  			}
  			else {
    ...
    return (
      <div className="form-container">
        ...
        <input
          type="text"
          value={record}
          placeholder="what's your angel power?"
